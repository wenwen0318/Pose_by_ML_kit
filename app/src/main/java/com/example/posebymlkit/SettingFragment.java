...
public class SettingFragment extends Fragment {
    ...
    public void transformCamera(boolean isChecked){
        if(isChecked){
            ...
            Toast.makeText(getContext(),getResources().getString(R.string.back_lens),Toast.LENGTH_SHORT).show();
        }
        else{
            camera_facing = CameraCharacteristics.LENS_FACING_BACK;
            Toast.makeText(getContext(),getResources().getString(R.string.front_lens),Toast.LENGTH_SHORT).show();
        }
    }
