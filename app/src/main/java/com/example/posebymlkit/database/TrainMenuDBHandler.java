...
public class TrainMenuDBHandler extends SQLiteOpenHelper {
    ...
    public String[] getPose(String menuName) {
        String[] trainMenu = new String[42];
        ...
        if (cursor.moveToFirst()) {
            do {
                for (int i = 0; i <= 40 ; i++){
                    if ( i % 2 == 0){
                        trainMenu[i] = cursor.getString(i);
                    }
                    else trainMenu[i] = Integer.toString((cursor.getInt(i));
                }
    ...
    public TrainMenu getMenu(String menuName) {
        ...
        Cursor cursor = db.query(TABLE_TRAIN_MENU, new String[] {
                        KEY_MENU_NAME,
                        KEY_POSE1, KEY_TIME1,
                        KEY_POSE2, KEY_TIME2,
                        KEY_POSE3, KEY_TIME3,
                        ...
                        KEY_POSE8, KEY_TIME8,
                        KEY_POSE9, KEY_TIME9,
                        KEY_POSE10, KEY_TIME10,
                        KEY_POSE11, KEY_TIME11,
                        KEY_POSE12, KEY_TIME12,
                        KEY_POSE13, KEY_TIME13,
                        KEY_POSE14, KEY_TIME14,
                        KEY_POSE15, KEY_TIME15,
                        KEY_POSE16, KEY_TIME16,
                        KEY_POSE17, KEY_TIME17,
                        KEY_POSE18, KEY_TIME18,
                        KEY_POSE19, KEY_TIME19,
                        KEY_POSE20, KEY_TIME20
                }, KEY_MENU_NAME + "=?",
                new String[] { String.valueOf(menuName) }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
        TrainMenu trainMenu = new TrainMenu(
                ...
                cursor.getString(13), cursor.getInt(14),
                cursor.getString(15), cursor.getInt(16),
                cursor.getString(17), cursor.getInt(18),
                cursor.getString(19), cursor.getInt(20),
                cursor.getString(21), cursor.getInt(22),
                cursor.getString(23), cursor.getInt(24),
                cursor.getString(25), cursor.getInt(26),
                cursor.getString(27), cursor.getInt(28),
                cursor.getString(29), cursor.getInt(30),
                cursor.getString(31), cursor.getInt(32),
                cursor.getString(33), cursor.getInt(34),
                cursor.getString(35), cursor.getInt(36),
                cursor.getString(37), cursor.getInt(38),
                cursor.getString(39), cursor.getInt(40)
        );
        // return contact
        return trainMenu;
    }
