...
public class HistoricalRecordDBHandler extends SQLiteOpenHelper {
    ...
    public void addHistoricalRecord(HistoricalRecord historicalRecord) {
        ...
        values.put(KEY_MODE, historicalRecord.getMode());
        ...
        values.put(KEY_ANKLE_LONG_THEN_SHOULDER, historicalRecord.getAnkleLongThenShoulder());
    ...
    public List<HistoricalRecord> getAllHistoricalRecord() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                historicalRecord.setAnkleLongThenShoulder(cursor.getString(29));
